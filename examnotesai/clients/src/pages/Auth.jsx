        ...
        <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
         ...
         bg-clip-text text-transparent'>
          ...
          transition={{duration:0.7}}>
             ...
             bg-clip-text text-transparent">
                You get <span className="font-semibold">100 FREE</span> to create
                exam notes, project notes, charts , graphs and 
                download clean PDFs - instantly using AI.
             </p>
             <p className='mt-4 text-sm text-gray-500'>Start with 100 free credits * Upgrade anytime for more credits * 
                Instant access
             </p>
